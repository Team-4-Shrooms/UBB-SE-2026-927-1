...
builder.Services.AddSingleton<IAuthTokenProvider>(sp => sp.GetRequiredService<JwtTokenStore>());
builder.Services.AddSingleton<ICurrentUserService>(sp => sp.GetRequiredService<JwtTokenStore>());
