...
namespace MovieApp.Proxy
{
    public class VideoStorageProxyRepository : IVideoStorageRepository
    {
        ...
        public VideoStorageProxyRepository(ApiClient apiClient) => _apiClient = apiClient;

        public async Task<Reel> InsertReelAsync(Reel reel)
        {
            var result = await _apiClient.PostAsync<object, Reel>("api/video-storage/reels", new
            {
